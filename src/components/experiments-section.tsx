      ...
      <div className="container-width text-center relative z-10">
        ...
        >
          <h1 className="font-space text-5xl md:text-7xl lg:text-8xl font-bold mb-6">
            Beyond projects:{" "}
            <span className="text-gradient block">some experiences</span>
          </h1>

          <p className="text-xl md:text-2xl text-text-secondary mb-12 max-w-3xl mx-auto leading-relaxed">
            "Not just client work — I also code to gain personal experience
            through side projects, and I’m happy to contribute to the community
            via open-source."{" "}
          </p>
        </motion.div>
      </div>
